...
errorDF[errorDF.count_double_word != errorDF.count_bigram_update].to_csv('/home/faris/Desktop/errorDF1.csv', sep=';')

pd.DataFrame(data = [double_word, count_double_word, update_bigram, count_bigram_update]).T.to_csv('/home/faris/Desktop/errorDF11.csv', sep=';')